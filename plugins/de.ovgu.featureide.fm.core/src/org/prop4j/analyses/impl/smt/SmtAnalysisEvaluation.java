 ...
 * @author User
 */
public class SmtAnalysisEvaluation extends AbstractSmtSolverAnalysis<Object[]> {

	private Object variable;

	public SmtAnalysisEvaluation(ISmtSolver solver) {
		super(solver);
	}
	...
	public Object[] analyze(IMonitor monitor) {
		...
		final long overHeadEnd = System.currentTimeMillis();
		long start = System.currentTimeMillis();
		result[0] = solver.minimum(variable);
		final long minDur = System.currentTimeMillis() - start;
		start = System.currentTimeMillis();
		result[1] = solver.maximum(variable);
		final long maxDur = System.currentTimeMillis() - start;
