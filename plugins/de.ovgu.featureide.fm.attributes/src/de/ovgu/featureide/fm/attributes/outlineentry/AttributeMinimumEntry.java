...
import de.ovgu.featureide.fm.attributes.computations.impl.SmtMinimumComputation;
...
public class AttributeMinimumEntry implements IOutlineEntry {
	...
	SmtMinimumComputation exactMinimum;
	Double result;
	...
	public void handleDoubleClick() {
		if (labelSuffix.equals(EST)) {
			exactMinimum = new SmtMinimumComputation(config, attribute);
			result = (Double) exactMinimum.getExactMinimum();
			labelSuffix = "";
		}
	}
