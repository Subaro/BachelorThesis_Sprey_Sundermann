...
import de.ovgu.featureide.fm.attributes.computations.impl.SmtMaximumComputation;
...
public class AttributeMaximumEntry implements IOutlineEntry {
	...
	SmtMaximumComputation exactMax;
	...
	public void handleDoubleClick() {
		if (labelSuffix.equals(EST)) {
			exactMax = new SmtMaximumComputation(config, attribute);
			result = (Double) exactMax.getExactMaximum();
			labelSuffix = "";
		}
	}
